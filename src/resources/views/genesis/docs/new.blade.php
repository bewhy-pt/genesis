...
@section('nav-genesis-new','active')
...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fe fe-command mr-2"></i>@lang('translation::genesis.breadcrumbs.new')</li>
        </ol>
    </nav>
@endsection

...
@section('nav-genesis-more','active')
...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fe fe-sunrise mr-2"></i>@lang('translation::genesis.breadcrumbs.more')</li>
        </ol>
    </nav>
@endsection
...
@section('main-content')
    ...
    <div class="col-lg-9">
        <div class="card">
            <div class="card-body">
                {{-- "####" . config('app.name') . "###" }}
                {{ dd(config('localization.supported-locales')) }}
                {{dd(session()) --}}

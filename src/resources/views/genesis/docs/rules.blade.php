...
@section('nav-genesis-rules','active')
...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fe fe-codepen mr-2"></i>@lang('translation::genesis.breadcrumbs.rules')</li>
        </ol>
    </nav>
@endsection
